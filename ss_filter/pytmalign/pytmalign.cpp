...
double pytmalign_main(int argc, char *argv[])
{
    double single_ans = 0.0;
        ...
        for (chain_i=0;chain_i<xchainnum;chain_i++)
        {
            ...
            for (j=(dir_opt.size()>0)*(i+1);j<chain2_list.size();j++)
            {
                ...
                for (chain_j=0;chain_j<ychainnum;chain_j++)
                {
                    ...
                    /*
                    if (TM3>0.3) {
                        fout << xname << ' ' << yname << ' ' << fixed <<setprecision(4) << TM3 << endl;
                        cout << xname << ' ' << yname << ' ' << fixed <<setprecision(4) << TM3 << endl;
                    }
                    */
                    //fout << xname << ' ' << yname << ' ' << fixed <<setprecision(4) << TM3 << endl;
                    //cout << xname << ' ' << yname << ' ' << fixed <<setprecision(4) << TM3 << endl;
                    //single_ans = (TM1 + TM2)/2;
                    single_ans = TM3;
    ...
    //cout << "single_ans:" << fixed << setprecision(4) << single_ans << endl;
    return single_ans;
}
...
namespace python_tmalign {
    ...
    double pytmalign::get_score (char * structure1, char * structure2) {
        int c = 5;
        char *v[5];
        v[0] = "./tmalign";
        v[1] = structure1;
