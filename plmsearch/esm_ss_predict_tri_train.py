...
from plmsearch_util.esm_ss_predict import esm_ss_dataset, esm_ss_predict_tri
...
def main():
    ...
    #input
    parser.add_argument('-mer', '--mean_esm_result', type=str, default='./plmsearch_data/esm_ss_predict/train/mean_esm_result.pkl', help="Mean esm result.")
    parser.add_argument('-il', '--input_list', type=str, default='./plmsearch_data/esm_ss_predict/train/protein_list.txt', help="Iutput protein list, decide the protein order of the ss_mat.")
    parser.add_argument('-im', '--input_mat', type=str, default='./plmsearch_data/esm_ss_predict/train/ss_mat.npz', help="Input mat name.")
